...
import { useBatchesSummary } from '@/services/paginated-batches';
...
export const StudentFilters = ({
    ...
    // Use paginated batches summary to check if batches exist
    // This removes dependency on loading all batches_for_sessions
