                ...
                <div className="flex flex-1 flex-col gap-4">
                    <div className="flex flex-1 flex-col gap-4 rounded-lg border border-neutral-200/50 bg-white p-4">
                        <div className="text-center py-8">
                            <h3 className="text-lg font-medium text-neutral-700 mb-2">Leads Management</h3>
                            <p className="text-neutral-600 mb-4">This is a placeholder for the leads management table.</p>
                            <div className="text-sm text-neutral-500">
                                The full table with data will be displayed here once the API is integrated.
                            </div>
                        </div>
                    </div>
                </div>
