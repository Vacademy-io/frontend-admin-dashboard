...
export function RegistrationListPage() {
    ...
    const handleNewApplication = () => {
        ...
        if (selectedSessionId) {
            window.location.href = `/admissions/registration/new?sessionId=${selectedSessionId}`;
        } else {
            window.location.href = '/admissions/registration/new';
        }
    };
    ...
    const handleFetchEnquiry = async () => {
        ...
        try {
            ...
            if (selectedSessionId) {
                window.location.href = `/admissions/registration/new?sessionId=${selectedSessionId}&enquiryData=${encodedData}`;
            } else {
                window.location.href = `/admissions/registration/new?enquiryData=${encodedData}`;
            }
        } catch (error) {
