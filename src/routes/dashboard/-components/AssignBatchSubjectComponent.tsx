...
export const AssignBatchSubjectComponent: React.FC<AssignBatchSubjectComponentProps> = ({
    ...
    const onSubmit = () => {
        console.log('Submitting assignments for teacher:', teacher.id);
    ...
    const onError = () => {
        toast.error('Batch must have at least one subject assigned.');
    };
    ...
    return (
        <DialogContent className="z-[500] flex max-h-[38rem] w-full max-w-2xl flex-col p-0">
                                ...
                                {availableBatches.map((batch) => (
                                    ...
                                    >
                                        ...
                                        {selectedBatches.includes(batch.id) && (
                                            <div className="ml-8">
                                                <FormLabel className="text-sm text-primary-400">
