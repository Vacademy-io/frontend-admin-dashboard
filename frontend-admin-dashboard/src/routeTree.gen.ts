...
import { Route as AdmissionPaymentSettingsRouteImport } from "./routes/admission/payment-settings"
import { Route as AdmissionInquiryRouteImport } from "./routes/admission/inquiry"
import { Route as AdmissionDocumentVerificationRouteImport } from "./routes/admission/document-verification"
import { Route as AdmissionAdmissionFormRouteImport } from "./routes/admission/admission-form"
...
const AdmissionRegistrationRoute = AdmissionRegistrationRouteImport.update({
  ...
  import("./routes/admission/registration.lazy").then((d) => d.Route),
)
const AdmissionPaymentSettingsRoute =
  AdmissionPaymentSettingsRouteImport.update({
    id: "/admission/payment-settings",
    path: "/admission/payment-settings",
    getParentRoute: () => rootRouteImport,
  } as any).lazy(() =>
    import("./routes/admission/payment-settings.lazy").then((d) => d.Route),
  )
const AdmissionInquiryRoute = AdmissionInquiryRouteImport.update({
  id: "/admission/inquiry",
  path: "/admission/inquiry",
  getParentRoute: () => rootRouteImport,
} as any).lazy(() =>
  import("./routes/admission/inquiry.lazy").then((d) => d.Route),
)
const AdmissionDocumentVerificationRoute =
  AdmissionDocumentVerificationRouteImport.update({
    id: "/admission/document-verification",
    path: "/admission/document-verification",
    getParentRoute: () => rootRouteImport,
  } as any).lazy(() =>
    import("./routes/admission/document-verification.lazy").then(
      (d) => d.Route,
    ),
  )
const AdmissionAdmissionFormRoute = AdmissionAdmissionFormRouteImport.update({
  id: "/admission/admission-form",
  path: "/admission/admission-form",
  getParentRoute: () => rootRouteImport,
} as any).lazy(() =>
  import("./routes/admission/admission-form.lazy").then((d) => d.Route),
)
...
export interface FileRoutesByFullPath {
  ...
  "/admission/admission-form": typeof AdmissionAdmissionFormRoute
  "/admission/document-verification": typeof AdmissionDocumentVerificationRoute
  "/admission/inquiry": typeof AdmissionInquiryRoute
  "/admission/payment-settings": typeof AdmissionPaymentSettingsRoute
...
export interface RootRouteChildren {
  ...
  AdmissionAdmissionFormRoute: typeof AdmissionAdmissionFormRoute
  AdmissionDocumentVerificationRoute: typeof AdmissionDocumentVerificationRoute
  AdmissionInquiryRoute: typeof AdmissionInquiryRoute
  AdmissionPaymentSettingsRoute: typeof AdmissionPaymentSettingsRoute
...
declare module "@tanstack/react-router" {
  interface FileRoutesByPath {
    ...
    "/admission/payment-settings": {
      id: "/admission/payment-settings"
      path: "/admission/payment-settings"
      fullPath: "/admission/payment-settings"
      preLoaderRoute: typeof AdmissionPaymentSettingsRouteImport
      parentRoute: typeof rootRouteImport
    }
    "/admission/inquiry": {
      id: "/admission/inquiry"
      path: "/admission/inquiry"
      fullPath: "/admission/inquiry"
      preLoaderRoute: typeof AdmissionInquiryRouteImport
      parentRoute: typeof rootRouteImport
    }
    "/admission/document-verification": {
      id: "/admission/document-verification"
      path: "/admission/document-verification"
      fullPath: "/admission/document-verification"
      preLoaderRoute: typeof AdmissionDocumentVerificationRouteImport
      parentRoute: typeof rootRouteImport
    }
    "/admission/admission-form": {
      id: "/admission/admission-form"
      path: "/admission/admission-form"
      fullPath: "/admission/admission-form"
      preLoaderRoute: typeof AdmissionAdmissionFormRouteImport
      parentRoute: typeof rootRouteImport
    }
    "/workflow/list/": {
      id: "/workflow/list/"
...
const rootRouteChildren: RootRouteChildren = {
  ...
  AdmissionAdmissionFormRoute: AdmissionAdmissionFormRoute,
  AdmissionDocumentVerificationRoute: AdmissionDocumentVerificationRoute,
  AdmissionInquiryRoute: AdmissionInquiryRoute,
  AdmissionPaymentSettingsRoute: AdmissionPaymentSettingsRoute,
