...
export const SidebarItemsData: SidebarItemsType[] = [
    ...
    },
    {
        ...
        subItems: [
            {
                subItem: 'Inquiry',
                subItemLink: '/admission/inquiry',
                subItemId: 'admission-inquiry',
            },
            {
                subItem: 'Registration',
                subItemLink: '/admission/registration',
                subItemId: 'admission-registration',
            },
            {
                subItem: 'Admission Form',
                subItemLink: '/admission/admission-form',
                subItemId: 'admission-form',
            },
            {
                subItem: 'Document Verification',
                subItemLink: '/admission/document-verification',
                subItemId: 'document-verification',
            },

            {
                subItem: 'Payment Settings',
                subItemLink: '/admission/payment-settings',
                subItemId: 'payment-settings',
            },
